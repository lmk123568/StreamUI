...
class ONVIFService(object):
    ...
    def __init__(
        ...
        if not zeep_client:
            ...
            self.zeep_client.set_ns_prefix(
            ...
            self.zeep_client.set_ns_prefix(
                "ttr", "http://www.onvif.org/ver10/media/wsdl"
            )
...
class ONVIFCamera(object):
    ...
    def __init__(
        ...
        no_cache=False,
        adjust_time=False,
        event_pullpoint=True,
        transport=None,
        override_camera_address=False,
    ):
    ...
    def update_xaddrs(self):
        ...
        if self._override_camera_address:
            self.xaddrs = {
                service: self._replace_netloc_in_url(url, self.host, self.port)
    ...
    def create_pullpoint_service(self, transport=None):
        return self.create_onvif_service(
            "pullpoint", portType="PullPointSubscription", transport=transport
        )
